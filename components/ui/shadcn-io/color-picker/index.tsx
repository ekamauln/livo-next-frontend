...
export const ColorPicker = ({
  ...
  useEffect(() => {
    if (value && value !== prevValueRef.current && !isInternalUpdate) {
  ...
  // Notify parent of changes with debounce to prevent infinite loops
  ...
  useEffect(() => {
    const timeoutId = setTimeout(notifyChange, 10);
