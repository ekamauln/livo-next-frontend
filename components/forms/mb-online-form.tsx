...
interface MbOnlineFormProps {
  onMbOnlineCreated?: () => void;
}

export function MbOnlineForm({ onMbOnlineCreated }: MbOnlineFormProps) {
  ...
  const onSubmit = async (data: FormData) => {
    try {
      const response = await mbOnlineApi.createMbOnline({
      ...
      if (response && response.success) {
        ...
        toast.success("MB-Online created successfully!");
        ...
        const errorMsg = response?.message || "Failed to create MB-Online";
      ...
      if (error instanceof ApiError) {
        ...
        console.error("Error creating MB-Online:", error);
      }
      ...
      form.reset();
      toast.error("Failed to create MB-Online", {
