...
interface PcOnlineFormProps {
  onPcOnlineCreated?: () => void;
}

export function PcOnlineForm({ onPcOnlineCreated }: PcOnlineFormProps) {
  ...
  const onSubmit = async (data: FormData) => {
    try {
      ...
      const response = await pcOnlineApi.createPcOnline(requestData);
      ...
      if (error instanceof ApiError) {
        ...
        console.error("Error creating PC-Online:", error);
      }
      ...
      setBoxSearchOpen([false]); // Reset search states
      setBoxSearch([""]);
      toast.error("Failed to create PC-Online", {
